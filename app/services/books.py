...
def list_books(
    ...
    order_clauses = []
    if sort == "title":
        order_clauses.extend([Book.title.asc(), Book.id.asc()])
    elif sort == "-title":
        order_clauses.extend([Book.title.desc(), Book.id.asc()])
    elif sort == "price":
        order_clauses.extend([Book.price_cents.asc(), Book.id.asc()])
    elif sort == "-price":
        order_clauses.extend([Book.price_cents.desc(), Book.id.asc()])
    else:
        order_clauses.append(Book.id.asc())
